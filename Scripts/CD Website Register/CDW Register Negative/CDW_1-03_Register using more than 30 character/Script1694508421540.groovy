...
WebUI.setText(findTestObject('Website/Make Account Page/Field_Name'), GlobalVariable.RegisterNameMorethan30characterNegative)
...
WebUI.verifyElementText(findTestObject('Website/Make Account Page/Text_Nama maksimal 30 karakter'), 'Nama maksimal 30 karakter.')
