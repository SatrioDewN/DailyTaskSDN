...
WebUI.setText(findTestObject('Website/My Profile Page/Field_Phone Whatsapp Profile'), '')

WebUI.click(findTestObject('Website/My Profile Page/Button_Save Changes'))

WebUI.verifyElementText(findTestObject('Website/My Profile Page/Text_The whatsapp field is required'), 'The whatsapp field is required.')
