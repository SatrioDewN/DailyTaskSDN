...
WebUI.setText(findTestObject('Website/My Profile Page/Field_Phone Whatsapp Profile'), '123123123123123')

WebUI.click(findTestObject('Website/My Profile Page/Button_Save Changes'))

WebUI.verifyElementText(findTestObject('Website/My Profile Page/Text_The whatsapp field is required'), 'The whatsapp must be between 10 and 12 digits.')
