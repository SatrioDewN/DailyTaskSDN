...
WebUI.setText(findTestObject('Website/My Profile Page/input_Phone_whatsapp'), '123123123123123')

WebUI.click(findTestObject('Object Repository/Website/My Profile Page/button_Save Changes'))

WebUI.verifyElementText(findTestObject('Website/My Profile Page/strong_The whatsapp field is required'), 'The whatsapp must be between 10 and 12 digits.')
