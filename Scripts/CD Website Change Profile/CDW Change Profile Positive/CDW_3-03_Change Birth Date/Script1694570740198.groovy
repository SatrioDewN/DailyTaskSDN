...
WebUI.setText(findTestObject('Website/My Profile Page/Field_Birth Day Profile'), '30-Jan-2000')

WebUI.click(findTestObject('Website/My Profile Page/Field_Phone Whatsapp Profile'))
