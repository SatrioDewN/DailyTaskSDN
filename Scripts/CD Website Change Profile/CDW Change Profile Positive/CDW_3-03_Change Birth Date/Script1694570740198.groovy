...
WebUI.setText(findTestObject('Website/My Profile Page/input_BirthDay_birth_date'), '30-Jan-2000')

WebUI.click(findTestObject('Website/My Profile Page/input_Phone_whatsapp'))
